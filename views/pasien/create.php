...
<div class="bg-white shadow-md rounded-lg"><form action="<?php echo $form_action; ?>" method="POST" class="p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <!-- PERUBAHAN DI SINI: Input No. RM sekarang readonly -->
        <div>
            <label for="no_rm" class="block text-sm font-medium text-gray-700">No. Rekam Medis (Otomatis)</label>
            <input type="text" id="no_rm" name="no_rm" value="<?php echo e($next_no_rm); ?>" readonly class="mt-1 block w-full rounded-md border-gray-300 shadow-sm bg-gray-100">
        </div>
